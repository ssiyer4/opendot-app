...
import com.example.opendottest.databinding.ReviewBinding;
...
public class Review extends AppCompatActivity {
    ...
    Uri imageUri; //uri reference includes a uri and a fragment
        ...
        storageReference.putFile(imageUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(Review.this,"Successfully Uploaded",Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        if (progressDialog.isShowing())
                            progressDialog.dismiss();
                        Toast.makeText(Review.this,"Failed to Upload",Toast.LENGTH_SHORT).show();
