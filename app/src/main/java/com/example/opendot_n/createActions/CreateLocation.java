...
import com.example.opendot_n.Location.AddLocation;
...
public class CreateLocation extends CreateMenu implements OnMapReadyCallback {
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(CreateLocation.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    private String NewLocationCoordinates;
    ...
    public void setupAutoCompleteFragment(){
        ...
        autocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(@NonNull Place place) {
                ...
                NewLocationCoordinates = place.getLatLng().toString();
